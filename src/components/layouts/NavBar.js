...
export default function NavBar() {
    return (
        ...
        <Link className="navbar-brand ml-5" to="/"><img src={logo} style={{width:'35px'}} alt="logo"/></Link>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav m-auto">
            <li className="nav-item active">
              <Link className="nav-link text-white text-uppercase ml-5" to="/">Home&nbsp;<i class="fas fa-home"/> <span class="sr-only">(current)</span></Link>
            </li>
